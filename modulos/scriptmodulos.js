...
if (sessionStorage.getItem('loggedIn') !== 'true') {  // Comparamos con 'true' como string
    ...
    window.location.href = '../modulos/login.html';  // Redirigir al login si no está logueado
} else {
    ...
    if (role === 'admin') {
        ...
        window.location.href = '../modulos/login.html'; // Redirigir si hay error en el rol
    }
}
...
document.getElementById('logoutBtn').addEventListener('click', function() {
    ...
    window.location.href = '../modulos/login.html';  // Asegúrate que este sea el nombre correcto del archivo de login
});
